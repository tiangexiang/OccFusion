...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], vis = False):
        """b
        ...
        elif 'zju_mocap_refine' in args.source_path or 'my_393' in args.source_path:
        ...
        # elif 'dna_rendering' in args.source_path or "DNA_rendering" in args.source_path:
        ...
        elif '0011_02' or 'w2a' in args.source_path:
            print("Assuming OcMotion dataset!")
            scene_info = sceneLoadTypeCallbacks["OcMotion"](args.source_path, args.gen_root, args.white_background, args.exp_name, args.eval)
        # elif os.path.exists(os.path.join(args.source_path, "smpl_annots.json")):
        #     print("Assuming EgoExo dataset!")
        #     scene_info = sceneLoadTypeCallbacks["EgoExo4D"](args.source_path, args.white_background, args.exp_name, args.eval)
        # elif "zju_occ" in args.source_path:
        #     print("Assuming ZJU Occluded dataset!")
        #     scene_info = sceneLoadTypeCallbacks["ZJUOcc"](args.source_path, args.white_background, args.exp_name, args.eval)
        else:
            print(os.path.join(args.source_path, "masks_gt"))
