...
class StableDiffusion(nn.Module):
    ...
    def get_text_embeds(self, prompts, negative_prompts):
        ...
        #nfsd_embeds = self.encode_text(nfsd_prompts)
        self.embeddings['pos'] = pos_embeds
        self.embeddings['neg'] = neg_embeds
        #self.embeddings['nfsd'] = nfsd_embeds
    ...
    @torch.no_grad()
    def get_control_embeds(self, image, name='default', res=512):
    ...
    def train_step(
        ...
        with torch.no_grad():
            ...
            if hors is None:
                embeddings = torch.cat([self.embeddings['pos'].expand(batch_size, -1, -1), self.embeddings['neg'].expand(batch_size, -1, -1), self.embeddings['neg'].expand(batch_size, -1, -1)])
            else:
                def _get_dir_ind(h):
            ...
            down_block_res_samples, mid_block_res_sample = self.controlnet(
                ...
                controlnet_cond=torch.cat([self.control_image[name]] * 3),
            ...
            noise_pred_cond, noise_pred_uncond, noise_pred_neg  = noise_pred.chunk(3)
            #noise_pred = noise_pred_uncond

            # print(noise_pred_uncond[0,0])
            # print(noise_pred_neg[0,0])
            # print('====')
            noise_pred = 0 * (
