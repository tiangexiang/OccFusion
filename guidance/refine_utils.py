...
class StableDiffusion(nn.Module):
    def __init__(
        ...
        pipe = StableDiffusionXLImg2ImgPipeline.from_pretrained(
            "stabilityai/stable-diffusion-xl-refiner-1.0", torch_dtype=self.dtype
        )
        ...
        self.unet = pipe.unet
        #print(self.tokenizer, self.text_encoder)
    ...
    def train_step(
        ...
        if as_latent:
            ...
            pred_rgb_512 = self.ratio_preserve_resize(pred_rgb, 512)
            #pred_rgb_512 = F.interpolate(pred_rgb, (512, 512), mode="bilinear", align_corners=False)
        ...
        with torch.no_grad():
            ...
            noise_pred = self.unet(
                latent_model_input, tt, encoder_hidden_states=embeddings, added_cond_kwargs=None
            ).sample
